...
<div class="rooms">
	<div class="container">
		...
		<div class="room-bottom">
			<h3>Lista de Comidas tipicas</h3>

					
<?php $sql = "SELECT * from tbltipicopackages";
...
{	?>
			<div class="rom-btm">
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					...
					<a href="package-tipica-details.php?pkgid=<?php echo htmlentities($result->PackageId);?>" class="view">Detalles</a>
				</div>
